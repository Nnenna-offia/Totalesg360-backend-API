...
class SelectorTests(TestCase):
    def setUp(self):
        ...
        FrameworkIndicator.objects.create(framework=self.framework, indicator=self.ind1, is_required=True, display_order=1)
        FrameworkIndicator.objects.create(framework=self.framework, indicator=self.ind2, is_required=False, display_order=2)
