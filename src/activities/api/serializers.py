...
class ActivityTypeListSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = ActivityType
		fields = ['id', 'name', 'unit', 'scope', 'indicator', 'display_order', 'data_type', 'collection_frequency', 'requires_evidence', 'is_required', 'is_active', 'created_at', 'updated_at']
		read_only_fields = ['id', 'created_at', 'updated_at']
...
class ActivityTypeDetailSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		fields = [
			...
			'display_order', 'data_type', 'collection_frequency', 'requires_evidence', 'is_required',
...
class ActivityTypeCreateUpdateSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		fields = ['name', 'description', 'scope', 'indicator', 'display_order', 'data_type', 'collection_frequency', 'requires_evidence', 'is_required', 'is_active']
